    ...
    >
      <div className="w-full max-w-sm rounded-md border border-black/10 bg-white p-6 text-center shadow-sm">
        ...
        <div className="mt-5 space-y-2">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-roast">Calendar</p>
          <h1 className="text-xl font-bold text-ink">Warming up the weekly board</h1>
          <p className="text-sm text-ink/65">Gathering reservations and table blocks.</p>
        </div>
