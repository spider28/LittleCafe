export const env = {
    ...
    geminiEndPoint: process.env.GEMINI_END_POINT ?? "https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",
    geminiEmbeddingModel: process.env.GEMINI_EMBEDDING_MODEL ?? "gemini-embedding-001",
    geminiEmbeddingEndPoint: process.env.GEMINI_EMBEDDING_END_POINT ?? "https://generativelanguage.googleapis.com/v1beta/openai/embeddings",
    geminiReasoningEffort: process.env.GEMINI_REASONING_EFFORT ?? "none",
